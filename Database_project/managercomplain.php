...
<body id="page-top">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Complain Profile 
...
while ($row = mysqli_fetch_assoc($result)) { ?>
            ...
            <td> <?php echo($row['complain_txt']);?></td>
            <td> <?php echo($row['date_of_submit']);?></td>
            ...
            <td> *** </td> -->
            <td>
            <!-- <button href="staff.php?action=delete_staff&id=<?php echo($row['id']);?>" type="submit" name="delete_btn" class="btn btn-danger badge-pill"> DELETE</button> -->
            </td>
...
<?php      } ?>  
    ...
    <div class="row ml-2 px-3">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Update complain Status</h6>
          <br><br>
          <form action="managerbackend.php" method="post">
                    <input type="hidden" name="action" value="update_complain">
                  
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="customerID">Complain ID</span>
            </div>
            <input type="text" class="form-control" id="customerID" name="id" aria-describedby="customerID">
          </div>
          ...
          <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#updatetechnicianprofile">
            Update 
          </button>
          </form >
